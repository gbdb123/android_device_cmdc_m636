...
# Kernel
TARGET_PREBUILT_KERNEL := device/cmdc/M636/kernel
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --dt device/cmdc/M636/dt.img
...
# Recovery
TARGET_RECOVERY_FSTAB := device/cmdc/M636/twrp.fstab
